...
#. Click |image1| to enable or disable SQL Terminal connection reuse.
   ...
   Refer to the :ref:`FAQs <en-us_topic_0000001188681066__en-us_topic_0185264547_li18661844113712>` section for the behavior of query execution with reuse and new connection.

   .. note::

      Use the existing SQL Terminal connection to edit temporary tables.

.. |image1| image:: /_static/images/en-us_image_0000001188681150.png
