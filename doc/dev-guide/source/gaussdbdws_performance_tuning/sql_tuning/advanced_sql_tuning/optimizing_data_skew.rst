...
In addition to the **table_skewness()** function, you can use the **table_distribution** function and the :ref:`PGXC_GET_TABLE_SKEWNESS <dws_04_0805>` view to efficiently query the data skew status of each table.
...
Computing skew is more difficult to detect than storage skew. To solve computing skew, GaussDB provides the Runtime Load Balance Technology (RLBT) solution, controlled by the :ref:`skew_option <en-us_topic_0000001811609661__section1211182712176>` parameter. The RLBT solution addresses how to detect and solve data skew.
