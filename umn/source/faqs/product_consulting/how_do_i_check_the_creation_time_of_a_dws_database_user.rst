...
How Do I Check the Creation Time of a DWS Database User?
========================================================

**Method 1**:

When you create a DWS database user, if the time when the user takes effect (**VALID BEGIN**) is the same as the creation time of the user, and the time when the user takes effect has not been changed, you can check the **valbegin** column in the **PG_USER** view to check the user creation time.
