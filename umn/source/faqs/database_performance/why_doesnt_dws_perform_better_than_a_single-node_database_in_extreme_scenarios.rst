...
Why Doesn't DWS Perform Better Than a Single-Node Database in Extreme Scenarios?
================================================================================
...
-  If such a problem occurs, see the section about query performance tuning in the *DWS Developer Guide*.
