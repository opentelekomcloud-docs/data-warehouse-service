...
Why Do Regular DWS Users Run Statements Slower Than User dbadmin?
=================================================================
...
#. Reasons for common users waiting in queues or global queues
   ...
   The primary reason for this queueing is the high number of active statements exceeding the maximum value set for **max_active_statements**. Administrators are exempt from queueing as they are not subject to any control measures. Modify the **max_active_statements** parameter on the DWS console.
