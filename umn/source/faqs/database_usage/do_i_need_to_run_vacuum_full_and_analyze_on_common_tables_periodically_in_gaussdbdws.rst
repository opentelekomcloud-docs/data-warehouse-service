...
.. note::
   ...
   -  In version 8.1.3 or later, **VACUUM**/**VACUUM FULL** can be invoked on the management plane. For details, see "Reclaiming GaussDB(DWS) Space Using Vacuum" in the *Data Warehouse Service (DWS) User Guide*.
