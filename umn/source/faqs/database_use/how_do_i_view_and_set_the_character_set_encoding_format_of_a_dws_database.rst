...
How Do I View and Set the Character Set Encoding Format of a DWS Database?
==========================================================================
...
-  **TEMPLATE [ = ] template**
   ...
   Indicates the template name, that is, the name of the template to be used to create the database. DWS creates a database by copying data from a database template. DWS initially has two database templates: **template0** and **template1**, as well as a default user database **postgres**.
