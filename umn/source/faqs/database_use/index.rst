:original_name: dws_03_0065.html
...
-  :ref:`How Do I Adjust DWS Distribution Columns? <dws_03_2126>`
-  :ref:`How Do I View and Set the Character Set Encoding Format of a DWS Database? <dws_03_0085>`
...
-  :ref:`How Do I Check Whether a DWS Table Is Row-Stored or Column-Stored? <dws_03_2100>`
-  :ref:`How Do I Query DWS Column-Store Table Information? <dws_03_2104>`
-  :ref:`Why Is the Index Invalid During DWS Query? <dws_03_2105>`
-  :ref:`How Do I Use a User-Defined DWS Function to Rewrite the CRC32() Function? <dws_03_2101>`
...
-  :ref:`How Do I Delete Duplicate Table Data from DWS? <dws_03_1004>`

.. toctree::
   :maxdepth: 1
   :hidden: 

   how_do_i_adjust_dws_distribution_columns
   how_do_i_view_and_set_the_character_set_encoding_format_of_a_dws_database
   ...
   how_do_i_check_whether_a_dws_table_is_row-stored_or_column-stored
   how_do_i_query_dws_column-store_table_information
   why_is_the_index_invalid_during_dws_query
   how_do_i_use_a_user-defined_dws_function_to_rewrite_the_crc32_function
   what_is_a_dws_schema_starting_with_pg_toast_temp_or_pg_temp
   solutions_to_inconsistent_dws_query_results
   which_system_catalogs_in_dws_cannot_undergo_the_vacuum_full_operation
   in_which_scenarios_will_a_dws_statement_be_in_the_idle_in_transaction_state
   how_does_dws_implement_row-to-column_and_column-to-row_conversion
   what_are_the_differences_between_dws_unique_constraints_and_unique_indexes
   what_are_the_differences_between_dws_functions_and_stored_procedures
   how_do_i_delete_duplicate_table_data_from_dws
