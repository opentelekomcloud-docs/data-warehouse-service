...
You can log in to the VPC management console to manually create a security group. Then, return to the DWS cluster creation page, click |image1| next to the **Security Group** drop-down list to refresh the page, and select the newly created security group.
