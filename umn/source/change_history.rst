...
|                                   |                                                                                                                                                |
|                                   | -  Display of the user lock flag when resource pool is linked to user                                                                          |
|                                   | -  Audit log dumping (supporting the selection of non-current tenant object buckets)                                                           |
|                                   | -  The message displayed for deleting a user has been optimized. The administrator can view the table objects associated with users.           |
+-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------+
| 2024-04-02                        | This issue is the seventeenth official release for cluster version 8.1.3.325.                                                                  |
|                                   |                                                                                                                                                |
|                                   | Added the following functions:                                                                                                                 |
|                                   |                                                                                                                                                |
...
|                                   | -  Associating with and disassociating from load balancers                                                                                     |
+-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                   | Modified the following sections:                                                                                                               |
|                                   |                                                                                                                                                |
|                                   | -  What Is DWS?: Added basic functions and reference document links.                                                                           |
...
|                                   |                                                                                                                                                |
|                                   | Deleted the following sections from this document. See more about the following sections in *Data Warehouse Service Database Developer Guide*. |
|                                   |                                                                                                                                                |
