...
#. Configure cluster parameters.
   ...
   .. figure:: /_static/images/en-us_image_0000002270494145.png
...
#. Configure network parameters.
   ...
   -  **Security Group**: Select **Automatic creation**.
      ...
      .. table:: **Table 1** Inbound rule example
         ...
         |                                   | .. note::                                                                                                                                                                  |
         |                                   |                                                                                                                                                                            |
         |                                   |    Enter the value of **Database Port** set when creating the DWS cluster. This port is used for receiving client connections to DWS. The default port number is **8000**. |
         +-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | Source                            | Select **IP address** and enter the IP address and subnet mask of the client host that accesses DWS, for example, **192.168.0.10/16**.                                     |
         +-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   .. figure:: /_static/images/en-us_image_0000002235494820.png
...
.. |image1| image:: /_static/images/en-us_image_0000002235494812.png
