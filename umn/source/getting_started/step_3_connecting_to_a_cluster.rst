...
#. :ref:`Obtaining the Public Network Address of the Cluster <en-us_topic_0000002270493801__section2301113635>`: Connect to the cluster database using the public network address.

#. :ref:`Connecting to the Cluster Database Using Data Studio <en-us_topic_0000002270493801__section99729517811>`: Download and configure the Data Studio client and connect to the cluster database.

.. _en-us_topic_0000002270493801__section2301113635:
...
#. In the cluster list, select a created cluster (for example, **dws-demo**) and click |image1| next to the cluster name to obtain the public network address.
   ...
   The public network address will be used in :ref:`Connecting to the Cluster Database Using Data Studio <en-us_topic_0000002270493801__section99729517811>`.


   .. figure:: /_static/images/en-us_image_0000002270374253.png
      :alt: **Figure 1** Cluster management

      **Figure 1** Cluster management

.. _en-us_topic_0000002270493801__section99729517811:

Connecting to the Cluster Database Using Data Studio
----------------------------------------------------

#. DWS provides a Windows-based Data Studio GUI client. The tool depends on JDK, so you must install Java 1.8.0_141 or later on the client host.
...
#. On the **Download Client and Driver** page, download **Data Studio GUI Client**.
   ...
   .. figure:: /_static/images/en-us_image_0000002235494868.png
...
#. Open the installation directory and double-click **Data Studio.exe** to start the Data Studio client. See :ref:`Figure 3 <en-us_topic_0000002270493801__fig6324139192412>`.

   .. _en-us_topic_0000002270493801__fig6324139192412:

   .. figure:: /_static/images/en-us_image_0000002235335040.png
      :alt: **Figure 3** Starting the client

      **Figure 3** Starting the client

#. Choose **File** > **New Connection** from the main menu. See :ref:`Figure 4 <en-us_topic_0000002270493801__fig14311312192811>`.

   .. _en-us_topic_0000002270493801__fig14311312192811:

   .. figure:: /_static/images/en-us_image_0000002270374233.png
...
#. In the displayed **New Database Connection** window, enter the connection parameters.
   ...
   When Enable SSL is selected, download the SSL certificate and decompress it by referring to :ref:`7.3.4-2 Downloading SSL Certificate <en-us_topic_0000002235494444__li13478842115911>`. Click the **SSL** tab and configure the following parameters:
   ...
   .. table:: **Table 2** Configuring SSL parameters
      ...
      |                                   | -  verify-ca                                                                                                                                                               |
      |                                   |                                                                                                                                                                            |
      |                                   | DWS does not support the **verify-full** mode.                                                                                                                             |
      +-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+


   .. figure:: /_static/images/en-us_image_0000002235335020.png
...
#. Click **OK** to establish the database connection.
   ...
   .. figure:: /_static/images/en-us_image_0000002270494173.png
...
.. |image1| image:: /_static/images/en-us_image_0000002270374241.png
