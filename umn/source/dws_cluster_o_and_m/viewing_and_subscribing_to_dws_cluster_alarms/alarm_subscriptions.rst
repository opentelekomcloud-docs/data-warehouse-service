...
#. .. _en-us_topic_0000002235494432__li125355552147:
   ...
   The **Subscribed Alarms** area displays the subscribed alarms by subscription settings. For details about the alarms that can be subscribed to, see :ref:`Table 1 <en-us_topic_0000002235494312__table1380210278592>`. Select an SMN topic from the drop-down list.
