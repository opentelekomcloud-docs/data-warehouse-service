...
Viewing DWS Database Audit Logs
===============================
...
-  The audit function has been enabled by setting **audit_enabled**. The default value of **audit_enabled** is **ON**. To disable audit, set it to **OFF** by referring to :ref:`Modifying GUC Parameters of the DWS Cluster <dws_01_0152>`.
-  The audit items have been configured. For how to enable audit items, see :ref:`Configuring the Database Audit Logs <en-us_topic_0000002235494384__section17422755918>`.
...
.. _en-us_topic_0000002235494384__section17422755918:
...
#. In the **Audit Settings** area, set the audit items:
   ...
   .. _en-us_topic_0000002235494384__en-us_topic_0000001098656870_table48954270153356:
   ...
   Except the audit items listed in :ref:`Table 1 <en-us_topic_0000002235494384__en-us_topic_0000001098656870_table48954270153356>`, key audit items in :ref:`Table 2 <en-us_topic_0000002235494384__en-us_topic_0000001098656870_table24262392153654>` are enabled by default on DWS.

   .. _en-us_topic_0000002235494384__en-us_topic_0000001098656870_table24262392153654:
...
Method 3: Database audit logs are stored in the database by default. After connecting to the cluster, you can use the **pg_query_audit** function to view the logs. For details, see :ref:`Using Functions to View Database Audit Logs <en-us_topic_0000002235494384__en-us_topic_0000001405788485_en-us_topic_0000001233761719_s0aec83296dc54e8f92966415aaaa3a6f>`.

.. _en-us_topic_0000002235494384__en-us_topic_0000001405788485_en-us_topic_0000001233761719_s0aec83296dc54e8f92966415aaaa3a6f:

Using Functions to View Database Audit Logs
-------------------------------------------

#. Use the SQL client tool to connect to the database cluster. For details, see :ref:`Connecting to a DWS Cluster <dws_01_0131>`.
...
.. |image1| image:: /_static/images/en-us_image_0000002270494073.png
