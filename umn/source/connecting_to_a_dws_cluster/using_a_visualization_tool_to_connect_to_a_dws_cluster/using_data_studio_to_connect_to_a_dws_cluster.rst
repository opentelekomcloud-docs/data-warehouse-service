...
-  You have configured the security group of the DWS cluster and added an inbound rule that allows users' IP addresses to access ports using the TCP.
...
#. Choose **Dedicated Clusters** > **Management** > **Client Connections**.
...
#. Choose **File** > **New Connection** from the main menu. See :ref:`Figure 2 <en-us_topic_0000002270493825__f5e30eb5f20c9434e971d8b2786b02dbf>`.
   ...
   .. _en-us_topic_0000002270493825__f5e30eb5f20c9434e971d8b2786b02dbf:
