...
#. :ref:`Granting an IAM Account the DWS Database Access Permission <en-us_topic_0000002270493885__section1560842714>`
#. :ref:`Creating an IAM User Credential <en-us_topic_0000002270493885__section5410134511612>`
#. :ref:`Configuring the JDBC Connection to Connect to a Cluster Using IAM Authentication <en-us_topic_0000002270493885__section289114226329>`

.. _en-us_topic_0000002270493885__section1560842714:
...
.. _en-us_topic_0000002270493885__section5410134511612:
...
.. table:: **Table 1** Database connection parameters
   ...
   |                                   | -  **eu-de** indicates the region where the cluster resides. JDBC accesses the DWS cluster in the corresponding region and delivers the IAM certificate to the cluster for IAM user authentication. The DWS service address has been recorded in the JDBC configuration file.                                                                                                                                                                           |
   ...
   |                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
   |                                   |    -  **auto**: The selection priority is EIP, ELB, and private IP address. If **auto** is selected, the system chooses an IP address for the connection.                                                                                                                                                                                                                                                                                               |
   |                                   |    -  **eip**: The system chooses an EIP for the connection.                                                                                                                                                                                                                                                                                                                                                                                            |
   |                                   |    -  **elb**: The system chooses an ELB for the connection. The selection priority is **elb_public** and **elb_private**.                                                                                                                                                                                                                                                                                                                              |
   |                                   |    -  **elb_public**: Use the ELB public IP address for the connection.                                                                                                                                                                                                                                                                                                                                                                                 |
   |                                   |    -  **elb_private**: Use ELB private IP address for the connection.                                                                                                                                                                                                                                                                                                                                                                                   |
   +-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
