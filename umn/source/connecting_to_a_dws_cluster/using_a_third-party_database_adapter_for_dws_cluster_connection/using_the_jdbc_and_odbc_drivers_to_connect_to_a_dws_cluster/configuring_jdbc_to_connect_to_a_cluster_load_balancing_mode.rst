...
#. Obtain the database connection.
   ...
   ::
      ...
      private static final String URL = "jdbc:postgresql://192.160.0.10:8000/gaussdb";
...
#. Obtain the database connection. For how to set URL parameters, see :ref:`Using JDBC to Connect to a Cluster <dws_01_0077>`.
   ...
   ::
      ...
      private static final String URL = "jdbc:postgresql://192.160.0.10:8000,192.168.0.11:8000,192.168.0.12:8000/gaussdb?loadBalanceHosts=true&cnListRefreshSwitch=on&cnListRefreshDelay=100000&cnListRefreshPeriod=5000
      ;
      private static Properties properties = new Properties();
      static {
          properties.setProperty("user", USER_NAME);
...
#. Obtain the database connection.
   ...
   ::
      ...
      private static final String PASSWORD = "password";
      // jdbc:postgresql://host1:port1,host2:port2/dbName"
      private static final String URL = "jdbc:postgresql://192.160.0.10:8000,192.168.0.11:8000,192.168.0.12:8000/gaussdb?loadBalanceHosts=true";
      private static Properties properties = new Properties();
      static {
          properties.setProperty("user", USER_NAME);
          properties.setProperty("password", PASSWORD);
