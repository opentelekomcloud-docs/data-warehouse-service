...
#. Run the following command to configure the DWS client:
...
#. Connect to the database in the DWS cluster using the gsql client.
   ...
   -  *Cluster_address*: For details about how to obtain this address, see :ref:`Obtaining the Connection Address of a DWS Cluster <dws_01_0033>`. If a public network address is used for connection, set this parameter to **Public Network Address** or **Public Network Domain Name**. If a private network address is used for connection, set this parameter to **Private Network Address** or **Private Network Domain Name**.
