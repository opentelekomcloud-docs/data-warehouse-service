...
#. Click **Download** to download the gsql CLI client matching the cluster version. Click **Historical Version** to download the gsql tool corresponding to the cluster version.
