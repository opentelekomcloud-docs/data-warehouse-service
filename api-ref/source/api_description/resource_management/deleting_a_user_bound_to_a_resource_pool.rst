:original_name: DeleteQueueUserList.html

.. _DeleteQueueUserList:
...
.. table:: **Table 2** Request body parameters
   ...
   |                 |                 |                                                                                                                  | N/A                          |
   +-----------------+-----------------+------------------------------------------------------------------------------------------------------------------+------------------------------+
   | user_list       | Yes             | Array of :ref:`user_list <en-us_topic_0000002500174008__en-us_topic_0000002374935221_request_user_list>` objects | **Definition**               |
   |                 |                 |                                                                                                                  |                              |
...
.. _en-us_topic_0000002500174008__en-us_topic_0000002374935221_request_user_list:
...
=========== ========================================
200         User bound to the resource pool deleted.
400         Request error.
