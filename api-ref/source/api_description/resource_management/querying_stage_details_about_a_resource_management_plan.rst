:original_name: ShowWorkloadPlanStage.html

.. _ShowWorkloadPlanStage:
...
.. table:: **Table 2** Response body parameters
   ...
   |                       |                                                                                                         | N/A                   |
   +-----------------------+---------------------------------------------------------------------------------------------------------+-----------------------+
   | workload_plan_stage   | :ref:`PlanStage <en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_planstage>` object | **Definition**        |
   |                       |                                                                                                         |                       |
   |                       |                                                                                                         | Plan stage details.   |
   |                       |                                                                                                         |                       |
   |                       |                                                                                                         | **Range**             |
...
.. _en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_planstage:

.. table:: **Table 3** PlanStage
   ...
   |                       |                                                                                                                                   | N/A                     |
   +-----------------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------+
   | queue_list            | Array of :ref:`QueueResourceItem <en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_queueresourceitem>` objects | **Definition**          |
   |                       |                                                                                                                                   |                         |
   |                       |                                                                                                                                   | Resource queue list.    |
   |                       |                                                                                                                                   |                         |
   |                       |                                                                                                                                   | **Range**               |
...
.. _en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_queueresourceitem:
...
.. table:: **Table 4** QueueResourceItem
   ...
   |                       |                                                                                                                                         | N/A                           |
   +-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------+-------------------------------+
   | queue_resources       | Array of :ref:`WorkloadResourceItem <en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_workloadresourceitem>` objects | **Definition**                |
   |                       |                                                                                                                                         |                               |
...
.. _en-us_topic_0000002500174026__en-us_topic_0000002374935205_response_workloadresourceitem:
...
=========== =========================================================
200         Stage details about the resource management plan queried.
400         Request error.
