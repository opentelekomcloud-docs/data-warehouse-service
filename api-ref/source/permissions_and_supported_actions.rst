...
-  :ref:`Managing Clusters <en-us_topic_0000002532013925__section15829194192310>`
-  :ref:`Managing Snapshots <en-us_topic_0000002532013925__section936022411233>`
-  :ref:`Managing Tags <en-us_topic_0000002532013925__section1916320474239>`

.. _en-us_topic_0000002532013925__section15829194192310:
...
+------------------------------------------------+--------------------------------------------------------------+-------------------------------------+-------------+--------------------+
| Starting a cluster                             | POST /v1/                                                    | dws:cluster:startCluster            | Y           | x                  |
|                                                |                                                              |                                     |             |                    |
|                                                | {project_id}/clusters/{cluster_id}/start                     |                                     |             |                    |
+------------------------------------------------+--------------------------------------------------------------+-------------------------------------+-------------+--------------------+
| Stopping a cluster                             | POST /v1/{project_id}/clusters/{cluster_id}/stop             | dws:cluster:stopCluster             | Y           | x                  |
+------------------------------------------------+--------------------------------------------------------------+-------------------------------------+-------------+--------------------+

.. _en-us_topic_0000002532013925__section936022411233:
...
.. _en-us_topic_0000002532013925__section1916320474239:
