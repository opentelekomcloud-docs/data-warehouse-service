...
html_title = "Data Warehouse Service - API Reference"
...
latex_documents = [
    ('index',
     'dws-api-ref.tex',
     u'Data Warehouse Service - API Reference',
