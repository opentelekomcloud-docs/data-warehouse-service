...
#. Obtain the VPC and subnet ID for subsequent use in :ref:`Creating a Cluster <createcluster>`.
...
#. Obtain the security group ID for subsequent use in :ref:`Creating a Cluster <createcluster>`.
