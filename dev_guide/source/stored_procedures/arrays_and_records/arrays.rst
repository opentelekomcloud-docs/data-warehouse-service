...
In GaussDB(DWS) 8.1.0 and earlier versions, the system does not verify the length of array elements and out-of-bounds write because the array can automatically increase. This version adds related constraints to be compatible with Oracle databases. If out-of-bounds write exists, you can configure **varray_verification** in the parameter :ref:`behavior_compat_options <en-us_topic_0000001233563213__section1980124735516>` to be compatible with previously unverified operations.
