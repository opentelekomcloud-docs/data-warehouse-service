...
:ref:`Table 1 <en-us_topic_0000001145694949__table11636114145319>` lists interfaces supported by the **DBMS_SQL** package.

.. _en-us_topic_0000001145694949__table11636114145319:
...
.. table:: **Table 1** DBMS_SQL
   ...
   | API                                                                                   | Description                                                                                             |
   +=======================================================================================+=========================================================================================================+
   | :ref:`DBMS_SQL.OPEN_CURSOR <en-us_topic_0000001145694949__li1531162015334>`           | Opens a cursor.                                                                                         |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.CLOSE_CURSOR <en-us_topic_0000001145694949__li156795412510>`           | Closes an open cursor.                                                                                  |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.PARSE <en-us_topic_0000001145694949__li2228125392012>`                 | Transmits a group of SQL statements to a cursor. Currently, only the **SELECT** statement is supported. |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.EXECUTE <en-us_topic_0000001145694949__li55721712815>`                 | Performs a set of dynamically defined operations on the cursor.                                         |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.FETCHE_ROWS <en-us_topic_0000001145694949__li126241517289>`            | Reads a row of cursor data.                                                                             |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN <en-us_topic_0000001145694949__li93441630193318>`        | Dynamically defines a column.                                                                           |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_CHAR <en-us_topic_0000001145694949__li15241105533618>`   | Dynamically defines a column of the CHAR type.                                                          |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_INT <en-us_topic_0000001145694949__li1061171414373>`     | Dynamically defines a column of the INT type.                                                           |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_LONG <en-us_topic_0000001145694949__li3604521153710>`    | Dynamically defines a column of the LONG type.                                                          |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_RAW <en-us_topic_0000001145694949__li17405103123711>`    | Dynamically defines a column of the RAW type.                                                           |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_TEXT <en-us_topic_0000001145694949__li163691742193714>`  | Dynamically defines a column of the TEXT type.                                                          |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.DEFINE_COLUMN_UNKNOWN <en-us_topic_0000001145694949__li8476651143718>` | Dynamically defines a column of an unknown type.                                                        |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE <en-us_topic_0000001145694949__li182631611152817>`        | Reads a dynamically defined column value.                                                               |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_CHAR <en-us_topic_0000001145694949__li55491765289>`       | Reads a dynamically defined column value of the CHAR type.                                              |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_INT <en-us_topic_0000001145694949__li169604123012>`       | Reads a dynamically defined column value of the INT type.                                               |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_LONG <en-us_topic_0000001145694949__li9209325173117>`     | Reads a dynamically defined column value of the LONG type.                                              |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_RAW <en-us_topic_0000001145694949__li1644815212328>`      | Reads a dynamically defined column value of the RAW type.                                               |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_TEXT <en-us_topic_0000001145694949__li5561542153219>`     | Reads a dynamically defined column value of the TEXT type.                                              |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.COLUMN_VALUE_UNKNOWN <en-us_topic_0000001145694949__li13946783337>`    | Reads a dynamically defined column value of an unknown type.                                            |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | :ref:`DBMS_SQL.IS_OPEN <en-us_topic_0000001145694949__li17449205852910>`              | Checks whether a cursor is opened.                                                                      |
   +---------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
...
-  .. _en-us_topic_0000001145694949__li1531162015334:
...
-  .. _en-us_topic_0000001145694949__li156795412510:
...
-  .. _en-us_topic_0000001145694949__li2228125392012:
...
-  .. _en-us_topic_0000001145694949__li55721712815:
...
-  .. _en-us_topic_0000001145694949__li126241517289:
...
-  .. _en-us_topic_0000001145694949__li93441630193318:
...
-  .. _en-us_topic_0000001145694949__li15241105533618:
...
-  .. _en-us_topic_0000001145694949__li1061171414373:
...
-  .. _en-us_topic_0000001145694949__li3604521153710:
...
-  .. _en-us_topic_0000001145694949__li17405103123711:
...
-  .. _en-us_topic_0000001145694949__li163691742193714:
...
-  .. _en-us_topic_0000001145694949__li8476651143718:
...
-  .. _en-us_topic_0000001145694949__li182631611152817:
...
-  .. _en-us_topic_0000001145694949__li55491765289:
...
-  .. _en-us_topic_0000001145694949__li169604123012:
...
-  .. _en-us_topic_0000001145694949__li9209325173117:
...
-  .. _en-us_topic_0000001145694949__li1644815212328:
...
-  .. _en-us_topic_0000001145694949__li5561542153219:
...
-  .. _en-us_topic_0000001145694949__li13946783337:
...
-  .. _en-us_topic_0000001145694949__li17449205852910:
