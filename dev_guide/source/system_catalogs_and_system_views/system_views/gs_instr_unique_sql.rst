...
.. _en-us_topic_0000001233883185__section1095316139818:
...
-  Unique SQL ID and normalized SQL text string. The normalized SQL text is described in :ref:`Examples <en-us_topic_0000001233883185__section1095316139818>`. Generally, constant values are ignored during Unique SQL ID calculation in DML statements. However, constant values cannot be ignored in DDL, DCL, and parameter setting statements.
...
-  Time distribution, including DB_TIME/CPU_TIME/EXECUTION_TIME/PARSE_TIME/PLAN_TIME/REWRITE_TIME/PL_EXECUTION_TIME/PL_COMPILATION_TIME/NET_SEND_TIME/DATA_IO_TIME. For details, see :ref:`Table 1 <en-us_topic_0000001233883185__table1350052261017>`. The information is collected on both CNs and DNs and is displayed during view query.
...
The GUC parameter :ref:`instr_unique_sql_timeout <en-us_topic_0000001233883261__section139316451814>` specifies the timeout interval of the Unique SQL statement (in hours). The background thread checks all Unique SQL statements every hour and deletes the Unique SQL statements whose **last_time** is **instr_unique_sql_timeout** hours ago.

.. _en-us_topic_0000001233883185__table1350052261017:
