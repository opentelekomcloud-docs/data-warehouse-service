...
.. _en-us_topic_0000001233563311__s8adb68393b48467a948956afaaaf8589:
...
-  Method 1: After a cluster is created, you can log in to the GaussDB(DWS) management console and modify the database parameters of the cluster.
   ...
   For details, see "Modifying Database Parameters" in the *Data Warehouse Service User Guide*.
